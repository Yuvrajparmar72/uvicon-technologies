      ...
      >
        ...
        <form className="flex flex-col gap-4 font-[family-name:var(--font-body)]">
          ...
          <div className="flex items-start gap-2 mt-2 text-sm">
            <input type="checkbox" className="w-4 h-4 mt-0.5 rounded bg-white/10 border border-white/20 accent-[#FFC050] shrink-0 cursor-pointer" />
            <label className="text-gray-400 cursor-pointer leading-tight">
              I agree to the <Link href="/privacy-policy" className="text-[#FFC050] hover:text-white transition-colors">Privacy Policy</Link> and <Link href="/refund-policy" className="text-[#FFC050] hover:text-white transition-colors">Terms of Service</Link>.
            </label>
          </div>

          <button type="button" className="w-full h-12 mt-4 bg-gradient-to-r from-[#FFC050] to-[#E6A639] hover:opacity-90 text-[#003D3F] font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(255,192,80,0.3)]">
        ...
        <p className="mt-8 text-center text-gray-400 text-sm font-[family-name:var(--font-body)]">
          Already have an account? <Link href="/login" className="text-[#FFC050] hover:text-white font-semibold transition-colors">Login here</Link>
        </p>
      </div>
    </div>
  );
