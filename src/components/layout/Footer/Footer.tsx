      ...
      <div className={styles.footerInner}>
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.brandColumn}>
            <Link href="/" className={styles.footerLogo} aria-label="Uvicon Technologies — Home">
              <Image
            ...
            <p className={styles.brandTagline}>
              Building high-performance digital solutions — websites, software,
              applications, games, and algo trading.
            </p>
          ...
          <div className={styles.linkColumn}>
            ...
            <div className={styles.columnLinks}>
              <Link href="/websites" className={styles.footerLink}>
                Websites
              </Link>
          ...
          <div className={styles.linkColumn}>
            ...
            <div className={styles.columnLinks}>
              ...
              <Link href="/faqs-tutorials" className={styles.footerLink}>
                FAQs &amp; Tutorials
              </Link>
              <Link href="/our-vision-values" className={styles.footerLink}>
                Our Vision &amp; Values
              </Link>
        ...
        <div className={styles.bottomBar}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} Uvicon Technologies. All rights
            reserved.
          </p>
